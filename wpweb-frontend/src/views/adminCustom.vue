                            ...
                            <el-collapse-item title="实体信息" name="entityDetail">
                                <el-form  label-width="100px" :model="entityDetailForm" :rules="entityDetailRules">
                                    <el-form-item label="表名" prop="name">
										<el-input v-model="entityDetailForm.name" @change="entityChanged=true" placeholder="必填。若重复则会冲掉原实体定义！！！"></el-input>
									</el-form-item>
                                    <el-form-item label="显示" prop="label">
										<el-input v-model="entityDetailForm.label" @change="entityChanged=true" placeholder="必填。"></el-input>
									</el-form-item>
                                    <el-form-item label="备注" prop="title">
										<el-input v-model="entityDetailForm.title" @change="entityChanged=true"></el-input>
									</el-form-item>
                                </el-form>
                            </el-collapse-item>
